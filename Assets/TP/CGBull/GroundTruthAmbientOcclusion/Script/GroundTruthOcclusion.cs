...
//////C# To Shader Property
    ...
    [SerializeField]
    SSAO_RenderResolution RenderSize = SSAO_RenderResolution.Full;
    ...
    private RenderTexture SSAO_SceneColor_RT, SSAO_Occlusion_RT, SSAO_Spatial_RT, SSAO_TemporalPrev_RT, SSAO_TemporalCurr_RT, SSAO_CombineScene_RT;
...
/* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* *//* */
    ...
    private void UpdateVariable_SSAO()
    {
        ...
        //----------------------------------------------------------------------------------
        SSAO_TexelSize = new Vector4(1 / ((float)RenderResolution.x / (float)RenderSize), 1 / ((float)RenderResolution.y / (float)RenderSize), 
                                            (float)RenderResolution.x / (float)RenderSize, (float)RenderResolution.y / (float)RenderSize);
        ...
        if (CameraSize != CurrentCameraSize) 
        {
            ...
            ////////////Occlusion RT
            RenderTexture.ReleaseTemporary(SSAO_Occlusion_RT);
            SSAO_Occlusion_RT = RenderTexture.GetTemporary((int)RenderResolution.x / (int)RenderSize, (int)RenderResolution.y / (int)RenderSize, 0, RenderTextureFormat.ARGBHalf);
            ...
            ////////////Temporal RT
            RenderTexture.ReleaseTemporary(SSAO_TemporalPrev_RT);
            SSAO_TemporalPrev_RT = RenderTexture.GetTemporary((int)RenderResolution.x, (int)RenderResolution.y, 0, RenderTextureFormat.RGHalf);
            RenderTexture.ReleaseTemporary(SSAO_TemporalCurr_RT);
            SSAO_TemporalCurr_RT = RenderTexture.GetTemporary((int)RenderResolution.x, (int)RenderResolution.y, 0, RenderTextureFormat.RGHalf);
    ...
    private void RenderSSAO()
    {
        ...
        GTAOBuffer.BlitSRT(SSAO_Spatial_RT, GTAOMaterial, 1);
        //YBlur
        GTAOBuffer.Blit(SSAO_Spatial_RT, SSAO_Occlusion_RT);
        ...
        GTAOBuffer.BlitSRT(SSAO_TemporalCurr_RT, GTAOMaterial, 3);
