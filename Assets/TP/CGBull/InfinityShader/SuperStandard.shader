Shader "CGBull/Infinity_Shader/SuperStandard" {
    ...
    SubShader {
        ...
        Pass {
            ...
            float _NormalTile, _Iridescence_Distance, _Reflectance, _SpecularLevel, _Roughness;
            float4 _BaseColor, _TransmissionColor;
            sampler2D _PreintegratedLUT, _NomralTexture; 
...
////// Material Property
                half3 BaseColor = _BaseColor.rgb * (1 - _Reflectance);
                ...
                #else
                    half3 SpecularColor = lerp(0.08 * _SpecularLevel, _BaseColor.rgb, _Reflectance);
                #endif
...
/////// Final Color
                ...
                half3 GlobalIllumination = (BaseColor * gi.indirect.diffuse * Preintegrated_DGF.a) + (gi.indirect.specular * Preintegrated_DGF.rgb * MultiScatterEnergy);

                half3 DefualtShading = Defult_Lit(BSDFContext, Attenuation, MultiScatterEnergy, BaseColor, SpecularColor, Roughness);
